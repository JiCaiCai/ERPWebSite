...
<script>
getColumnNameURL="manufacturingUnit.do?method=GetColumnName";
queryURL="manufacturingUnit.do?method=Query";
insertURL="manufacturingUnit.do?method=Insert";
deleteURL="manufacturingUnit.do?method=Delete";
updateURL="manufacturingUnit.do?method=Update";
GetColumnName();
</script>
</head>
<body>
